"""Frontend Controller topology stream and per-Worker connection lifetime."""
...
class ControllerTopologyWatcher(TopologyProvider):
    ...
    async def _install(
        ...
        required: dict[WorkerIdentity, WorkerRoute] = {}
