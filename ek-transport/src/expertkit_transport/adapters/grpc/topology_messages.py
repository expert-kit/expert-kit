...
RouteDescriptions = dict[tuple[int, int], tuple[GrpcWorkerRoute, ...]]
...
class TopologyMessageAssembler:
    ...
    def _decode_routes(
        ...
        *,
        ...
        worker_metadata: dict[WorkerIdentity, GrpcWorkerRoute] = {}
